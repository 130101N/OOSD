...
//        String sql = "INSERT INTO employee (name,dob,address,mobile,nic,gender,sign) values (";
//        sql = sql + "'" + employee.getName() + "' , '" + finishDate + "' , '" + employee.getAddress() + "' ,";
//        sql = sql + "'" + employee.getMobile() + "' , '" + employee.getNIC() + "' , 2 , ";
//        sql = sql + "'" + startDate + "' ";
//        sql = sql + ")";
