 ...
 * @author Nayomi
 */
public class EmpId extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cb.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "- Select -", "Distribution", "Printing", "CardShop" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(EmpId.class.getName()).log(Level.SEVERE, null, ex);
        }
        rows++;
